...
#define MyAppVersion "20.4"
#define MyAppPublisher "WBSEDCL / Pramod Kumar Verma"
#define MyAppExeName "SpotImageViewerV20.4.exe"
...
Source: "..\dist\SpotImageViewerV20.4\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
