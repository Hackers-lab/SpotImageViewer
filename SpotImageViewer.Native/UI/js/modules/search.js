...
function clearViewerState() {
  ...
  // Hide single view controls on clear
  ...
  if (placeholder) {
    ...
    placeholder.innerHTML = typeof getWelcomeScreenHtml === 'function'
      ? getWelcomeScreenHtml()
      : `<div class="flex flex-col items-center justify-center p-6 text-center text-slate-500"><h2 class="text-xl font-bold">Welcome to Spot Image Viewer</h2></div>`;
    safeCreateIcons();
  }
