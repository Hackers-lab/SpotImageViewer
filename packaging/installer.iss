...
#define MyAppVersion "20.31"
#define MyAppPublisher "WBSEDCL / Pramod Kumar Verma"
#define MyAppExeName "SpotImageViewerV20.31.exe"
...
Source: "..\dist\SpotImageViewerV20.31\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
