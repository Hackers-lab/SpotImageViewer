...
#define MyAppVersion "20.5"
#define MyAppPublisher "WBSEDCL / Pramod Kumar Verma"
#define MyAppExeName "SpotImageViewerV20.5.exe"
...
Source: "..\dist\SpotImageViewerV20.5\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
