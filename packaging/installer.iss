...
OutputDir=..\Output
OutputBaseFilename=SpotImageViewer_Setup_v{#MyAppVersion}
...
Source: "..\dist\SpotImageViewerV{#MyAppVersion}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
